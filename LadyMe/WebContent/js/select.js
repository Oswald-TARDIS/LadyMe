...
document.write('<select name="hw_1" onChange = "hw_select()"></select> <select name="hw_2" onChange = "hw_select()"></select> <input class="input" size="15" type="input" value="'+hwdefault_value+'" name="originPlace">\n');
...
function hw_select()
{
 ...
 document.all.originPlace.value=hwSelect_s12+""+hwSelect_s14;
}
function hw_init()
{
 with(document.all.hw_1)
