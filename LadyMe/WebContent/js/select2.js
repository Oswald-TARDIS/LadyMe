...
//<a href='http://www.daimajiayuan.com/sitejs-2206-1.html' target='_blank'><u>二级菜单</u></a>
...
var hwdefault_value = "浙江杭州"

//默认值，在值有相同时有bug。

document.write('<select name="hw_12" onChange = "hw_select2()"></select> <select name="hw_22" onChange = "hw_select2()"></select> <input class="input" size="15" type="input" value="'+hwdefault_value+'" name="destination">\n');
...
function hw_select2()
{
 ...
 document.all.destination.value=hwSelect_s12+""+hwSelect_s14;
}
function hw_init()
{
 with(document.all.hw_12)
